...
typedef int(__cdecl* GetScreenCoordsProc)(int, float*, float*, float, float,
                                          float);
...
int __cdecl mesDispWindowHook(int a1, int a2, int a3, int a4, int a5, int a6,
                              int a7, int a8);
...
bool menuButtonHitTest(int id, int x, int y, int bx, int by, int w, int h,
                       int* selIndexVar) {
...
void mouseSlider(int mouseX, int mouseY, int bX, int bY, int w, int h, int min,
                 int max, int& target, int id) {
  if (MovingSliderId == -1 &&
      mouseSelectHitTest(mouseX, mouseY, bX, bY, w, h) &&
      (InputObject->mouseButtonsHeld & MouseLeftClick ||
...
void mouseScrollBar(int mouseX, int mouseY, int bX, int bY, int w, int h,
                    int minVal, int maxVal, int minPos, int maxPos, int& target,
                    int id) {
  if (MovingSliderId == -1 &&
      mouseSelectHitTest(mouseX, mouseY, bX, bY, w, h) &&
      InputObject->mouseButtonsHeld & MouseLeftClick) {
  ...
  if (MovingSliderId == id) {
    if (InputObject->mouseButtonsHeld & MouseLeftClick && SliderMoving) {
      ...
      if (mouseY > maxPos + (h / 2))
        ...
        mouseY -= h / 2;
        target = minVal + (((mouseY - minPos) / (float)(maxPos - minPos)) *
                           (float)(maxVal - minVal));
      }
    } else {
      SliderMoving = false;
...
bool customInputInit() {
  ...
  TitleMenuSelectionIndex =
      (int*)sigScan("game", "useOfTitleMenuSelectionIndex");
  ...
  TitleSubMenuAnimCounter =
      (int*)sigScan("game", "useOfTitleSubMenuAnimCounter");

  MovieModeSelectionIndex =
      (int*)sigScan("game", "useOfMovieModeSelectionIndex");
  ...
  DailyRecordsUnlockedPages =
      (int*)sigScan("game", "useOfDailyRecordsUnlockedPages");
  DataCollectionMode = (int*)sigScan("game", "useOfDataCollectionMode");
  DataCollectionItemIndex =
      (int*)sigScan("game", "useOfDataCollectionItemIndex");
  ...
  SysMesBoxChoiceIndexAlt =
      (int*)sigScan("game", "useOfSysMesBoxChoiceIndexAlt");
  ...
  TipsMenuTipTextStartOffset =
      (int*)sigScan("game", "useOfTipsMenuTipTextStartOffset");
  ...
  BacklogFirstFullDispLine =
      (int*)sigScan("game", "useOfBacklogFirstFullDispLine");
  BacklogLastFullDispLine =
      (int*)sigScan("game", "useOfBacklogLastFullDispLine");
  ...
  ConfigPage1SelectedItem =
      (int*)sigScan("game", "useOfConfigPage1SelectedItem");
  ConfigPage2SelectedItem =
      (int*)sigScan("game", "useOfConfigPage2SelectedItem");
  ConfigPage3SelectedItem =
      (int*)sigScan("game", "useOfConfigPage3SelectedItem");
  ConfigSwitchAnimCounter =
      (int*)sigScan("game", "useOfConfigSwitchAnimCounter");
  ...
  ConfigVoiceCharaVolumeCur =
      (int*)sigScan("game", "useOfConfigVoiceCharaVolumeCur");
  ...
  if (!scanCreateEnableHook("game", "mgsInputExecuteServer",
                            (uintptr_t*)&gameExeMgsInputExecuteServer,
      ...
      !scanCreateEnableHook("game", "PADmain", (uintptr_t*)&gameExePADmain,
                            (LPVOID)&padMainHook, (LPVOID*)&gameExePADmainReal))
    return false;

  scanCreateEnableHook(
      "game", "InstTitleMenu", (uintptr_t*)&gameExeInstTitleMenu,
      (LPVOID)&instTitleMenuHook, (LPVOID*)&gameExeInstTitleMenuReal);
  scanCreateEnableHook(
      "game", "MovieModeDisp", (uintptr_t*)&gameExeMovieModeDisp,
      (LPVOID)&movieModeDispHook, (LPVOID*)&gameExeMovieModeDispReal);
  ...
  scanCreateEnableHook(
      "game", "InstSystemMes", (uintptr_t*)&gameExeInstSystemMes,
      (LPVOID)&instSystemMesHook, (LPVOID*)&gameExeInstSystemMesReal);
  scanCreateEnableHook(
      "game", "InstSystemMenu", (uintptr_t*)&gameExeInstSystemMenu,
      (LPVOID)&instSystemMenuHook, (LPVOID*)&gameExeInstSystemMenuReal);
  scanCreateEnableHook("game", "InstTips", (uintptr_t*)&gameExeInstTips,
                       (LPVOID)&instTipsHook, (LPVOID*)&gameExeInstTipsReal);
  scanCreateEnableHook(
      "game", "AlbumMenuMain", (uintptr_t*)&gameExeAlbumMenuMain,
      (LPVOID)&albumMenuMainHook, (LPVOID*)&gameExeAlbumMenuMainReal);
  scanCreateEnableHook(
      "game", "CGViewModeMain", (uintptr_t*)&gameExeCGViewModeMain,
      (LPVOID)&cgViewModeMainHook, (LPVOID*)&gameExeCGViewModeMainReal);
  scanCreateEnableHook("game", "PokecomMainMenuMain",
                       (uintptr_t*)&gameExePokecomMainMenuMain,
                       (LPVOID)&pokecomMainMenuMainHook,
                       (LPVOID*)&gameExePokecomMainMenuMainReal);
  scanCreateEnableHook(
      "game", "MusicMenuMain", (uintptr_t*)&gameExeMusicMenuMain,
      (LPVOID)&musicMenuMainHook, (LPVOID*)&gameExeMusicMenuMainReal);
  scanCreateEnableHook(
      "game", "BacklogMenuMain", (uintptr_t*)&gameExeBacklogMenuMain,
      (LPVOID)&backlogMenuMainHook, (LPVOID*)&gameExeBacklogMenuMainReal);
  gameExeBacklogRecalcMovement =
      (BacklogRecalcMovementProc)sigScan("game", "BacklogRecalcMovement");
  scanCreateEnableHook("game", "TwipoMain", (uintptr_t*)&gameExeTwipoMain,
                       (LPVOID)&twipoMainHook, (LPVOID*)&gameExeTwipoMainReal);
  scanCreateEnableHook(
      "game", "PokecomDocMain", (uintptr_t*)&gameExePokecomDocMain,
      (LPVOID)&pokecomDocMainHook, (LPVOID*)&gameExePokecomDocMainReal);
  scanCreateEnableHook(
      "game", "PokecomMapMain", (uintptr_t*)&gameExePokecomMapMain,
      (LPVOID)&pokecomMapMainHook, (LPVOID*)&gameExePokecomMapMainReal);
  scanCreateEnableHook(
      "game", "PokecomARMain", (uintptr_t*)&gameExePokecomARMain,
      (LPVOID)&pokecomARMainHook, (LPVOID*)&gameExePokecomARMainReal);
  scanCreateEnableHook("game", "InstOption", (uintptr_t*)&gameExeInstOption,
                       (LPVOID)&instOptionHook,
                       (LPVOID*)&gameExeInstOptionReal);
  scanCreateEnableHook(
      "game", "MesDispWindow", (uintptr_t*)&gameExeMesDispWindow,
      (LPVOID)&mesDispWindowHook, (LPVOID*)&gameExeMesDispWindowReal);
  scanCreateEnableHook(
      "game", "PokecomViewGeotag", (uintptr_t*)&gameExePokecomViewGeotag,
      (LPVOID)&pokecomViewGeotagHook, (LPVOID*)&gameExePokecomViewGeotagReal);
  ...
  gameExeGetScreenCoords =
      (GetScreenCoordsProc)sigScan("game", "GetScreenCoords");
  gameExeCountSC3Characters =
      (CountSC3CharactersProc)sigScan("game", "CountSC3Characters");
  gameExeGetSC3StringByID =
      (GetSC3StringByIDProc)sigScan("game", "GetSC3StringByID");
...
int __cdecl mesDispWindowHook(int a1, int a2, int a3, int a4, int a5, int a6,
  ...
  if (*MouseEnabled || AutoSkipAlphaStep) {
    ...
    if (!gameExeGetFlag(Pokecom_Disable) && gameExeGetFlag(CALENDAR_DISP)) {
      if (mouseSelectHitTest(mouseX, mouseY, 1246, 153, 674, 86) &&
          (InputObject->mouseButtons & MouseLeftClick))
    ...
    if (mouseSelectHitTest(mouseX, mouseY, 13, 1064, 128, 38)) {
      drawSpriteHook(80, 3805.0f, 1937.0f, 135.0f, 45.0f, 8.0f, 1022.0f,
                     0xFFFFFF, alpha, 1);
      if (InputObject->mouseButtons & MouseLeftClick) {
        CarryInputToTheNextFrame |= PAD1X;
      }
    } else {
      drawSpriteHook(80, 3805.0f, 1987.0f, 135.0f, 45.0f, 8.0f, 1022.0f,
                     0xFFFFFF, alpha, 1);
    }

    if (mouseSelectHitTest(mouseX, mouseY, 152, 1064, 128, 38)) {
      drawSpriteHook(80, 3944.0f, 1937.0f, 135.0f, 45.0f, 147.0f, 1022.0f,
                     0xFFFFFF, alpha, 1);
      if (InputObject->mouseButtons & MouseLeftClick) {
      ...
      drawSpriteHook(80, 3944.0f, 1987.0f, 135.0f, 45.0f, 147.0f, 1022.0f,
                     0xFFFFFF, alpha, 1);
    }
  }
...
int __cdecl instOptionHook(void* thread) {
  if (*MouseEnabled) {
    ...
    switch (*ConfigMenuCurrentPage) {
      case 0: {
        mouseSlider(mouseX, mouseY, 766, 399, 380, 38, 256, 4096,
                    *ConfigMessageSpeed, 0);
        *ConfigMessageSpeedCur = *ConfigMessageSpeed;
        mouseSlider(mouseX, mouseY, 766, 447, 380, 38, 2048, 256,
                    *ConfigAutoModeDelay, 1);
        *ConfigAutoModeDelayCur = *ConfigAutoModeDelay;
        mouseSlider(mouseX, mouseY, 766, 633, 380, 38, 0, 128,
                    *ConfigVoiceVolume, 2);
        *ConfigVoiceVolumeCur = *ConfigVoiceVolume;
        mouseSlider(mouseX, mouseY, 766, 681, 380, 38, 0, 128, *ConfigBGMVolume,
                    3);
        *ConfigBGMVolumeCur = *ConfigBGMVolume;
        mouseSlider(mouseX, mouseY, 766, 729, 380, 38, 0, 128, *ConfigSEVolume,
                    4);
        *ConfigSEVolumeCur = *ConfigSEVolume;
        mouseSlider(mouseX, mouseY, 766, 777, 380, 38, 0, 128,
                    *ConfigMovieVolume, 5);
        *ConfigMovieVolumeCur = *ConfigMovieVolume;
        ...
        if (!SliderMoving) {
          int index = 0;
          for (int i = 0; i < 3; i++) {
            menuButtonHitTest(index++, mouseX, mouseY, 97, 166 + (i * 48), 1120,
                              40, ConfigPage1SelectedItem);
          }
          index++;
          for (int i = 0; i < 3; i++) {
            menuButtonHitTest(index++, mouseX, mouseY, 97, 400 + (i * 48), 1120,
                              40, ConfigPage1SelectedItem);
          }
          for (int i = 0; i < 6; i++) {
            menuButtonHitTest(index++, mouseX, mouseY, 97, 634 + (i * 48), 1120,
                              40, ConfigPage1SelectedItem);
          }

          // Tips Info Switch
          if (mouseSelectHitTest(mouseX, mouseY, 964, 165, 190, 38) &&
              *ConfigTipsInfo && (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigTipsInfo = 0;
            *ConfigSwitchAnimCounter = 15;
            gameExePlaySE(17);
          }
          if (mouseSelectHitTest(mouseX, mouseY, 760, 165, 190, 38) &&
              !*ConfigTipsInfo &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigTipsInfo = 1;
            *ConfigSwitchAnimCounter = 15;
          ...
          // Full Screen Switch
          if (mouseSelectHitTest(mouseX, mouseY, 964, 213, 190, 38) &&
              *ConfigFullScreen &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigFullScreen = 0;
            *ConfigFullScreen1 = 0;
          ...
          if (mouseSelectHitTest(mouseX, mouseY, 760, 213, 190, 38) &&
              !*ConfigFullScreen &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigFullScreen = 1;
            *ConfigFullScreen1 = 1;
          ...
          // Resolution Switch
          if (mouseSelectHitTest(mouseX, mouseY, 760, 261, 127, 38) &&
              *ConfigResolution != 0 &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigResolution = 0;
            *ConfigResolution1 = 0;
          ...
          if (mouseSelectHitTest(mouseX, mouseY, 894, 261, 127, 38) &&
              *ConfigResolution != 1 &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigResolution = 1;
            *ConfigResolution1 = 1;
          ...
          if (mouseSelectHitTest(mouseX, mouseY, 1028, 261, 127, 38) &&
              *ConfigResolution != 2 &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigResolution = 2;
            *ConfigResolution1 = 2;
          ...
          // Skip Mode Switch
          if (mouseSelectHitTest(mouseX, mouseY, 760, 495, 190, 38) &&
              *ConfigSkipMode && (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigSkipMode = 0;
            gameExePlaySE(17);
            *ConfigSwitchAnimCounter = 15;
          }
          if (mouseSelectHitTest(mouseX, mouseY, 964, 495, 190, 38) &&
              !*ConfigSkipMode &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigSkipMode = 1;
            gameExePlaySE(17);
          ...
          // Sync Voice Switch
          if (mouseSelectHitTest(mouseX, mouseY, 964, 825, 190, 38) &&
              *ConfigSyncVoice &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigSyncVoice = 0;
            gameExePlaySE(17);
          ...
          if (mouseSelectHitTest(mouseX, mouseY, 760, 825, 190, 38) &&
              !*ConfigSyncVoice &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigSyncVoice = 1;
            gameExePlaySE(17);
          ...
          // Skip Voice Switch
          if (mouseSelectHitTest(mouseX, mouseY, 964, 873, 190, 38) &&
              *ConfigSkipVoice &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigSkipVoice = 0;
            gameExePlaySE(17);
          ...
          if (mouseSelectHitTest(mouseX, mouseY, 760, 873, 190, 38) &&
              !*ConfigSkipVoice &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            *ConfigSkipVoice = 1;
            gameExePlaySE(17);
      ...
      case 1: {
        for (int i = 0; i < 20; i++) {
          ...
          mouseSlider(mouseX, mouseY, 766, 165 + (i * 48), 380, 38, 0, 128,
                      ConfigVoiceCharaVolume[id], i);

          if (!SliderMoving) {
            menuButtonHitTest(i, mouseX, mouseY, 97, 166 + (i * 46), 1120, 38,
                              ConfigPage2SelectedItem);

            if (mouseSelectHitTest(mouseX, mouseY, 616, 165 + (i * 46), 134,
                                   38) &&
                ConfigVoiceEnableFlags[id] &&
                (InputObject->mouseButtons & MouseLeftClick)) {
              ConfigVoiceEnableFlags[id] = 0;
              gameExePlaySE(17);
              *ConfigSwitchAnimCounter = 15;
            }
            if (mouseSelectHitTest(mouseX, mouseY, 468, 165 + (i * 46), 134,
                                   38) &&
                !ConfigVoiceEnableFlags[id] &&
                (InputObject->mouseButtons & MouseLeftClick)) {
      ...
      case 2: {
        for (int i = 0; i < 7; i++) {
          ...
          if (mouseSelectHitTest(mouseX, mouseY, 964, 165 + (i * 48), 190,
                                 38) &&
              ConfigTwipoNotifs[*ConfigPage3SelectedItem] &&
              (InputObject->mouseButtons & MouseLeftClick)) {
            ConfigTwipoNotifs[*ConfigPage3SelectedItem] = 0;
            gameExePlaySE(17);
            *ConfigSwitchAnimCounter = 15;
          }
          if (mouseSelectHitTest(mouseX, mouseY, 760, 165 + (i * 48), 190,
                                 38) &&
              !ConfigTwipoNotifs[*ConfigPage3SelectedItem] &&
              (InputObject->mouseButtons & MouseLeftClick)) {
  ...
  if (*MouseEnabled && gameExeGetFlag(Pokecom_ManualMode)) {
    ...
    if (*ARNumDisplayedGeoTags) {
      for (int i = 0; i < *ARNumDisplayedGeoTags; i++) {
        ...
        gameExeGetScreenCoords(0, &x, &y, ARGeoTagsXYZCoords[xyzCnt],
                               12.5f + ARGeoTagsXYZCoords[xyzCnt + 1],
                               ARGeoTagsXYZCoords[xyzCnt + 2]);
        ...
        if (menuButtonHitTest(id, mouseX, mouseY, screenX, screenY + 150,
                              textWidth + 80, 150, ARSelectedGeoTag)) {
          if (InputObject->mouseButtons & MouseLeftClick) {
    ...
    if (gameExeGetFlag(KRep_SearchMode) && *ARPointingAtReport) {
      if (mouseSelectHitTest(mouseX, mouseY, 923, 581, 72, 70) &&
          (InputObject->mouseButtons & MouseLeftClick))
        *InputMask |= PAD1A;
    }
    ...
    if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
      gameExeScrWork[SW_AR_ANGLE_C] =
          gameExeScrWork[SW_AR_ANGLE_C] - 1000 > 10000
              ? gameExeScrWork[SW_AR_ANGLE_C] - 1000
              : 10000;
    } else if (InputObject->mouseButtonsHeld & MouseScrollWheelDown) {
      gameExeScrWork[SW_AR_ANGLE_C] =
          gameExeScrWork[SW_AR_ANGLE_C] + 1000 <
                  gameExeScrWork[SW_AR_ANGLE_M] - 500
              ? gameExeScrWork[SW_AR_ANGLE_C] + 1000
              : gameExeScrWork[SW_AR_ANGLE_M] - 500;
    }
...
int __cdecl pokecomViewGeotagHook() {
  if (*MouseEnabled && gameExeGetFlag(Pokecom_ManualMode)) {
    ...
    int width = 678;
    if (gameExeScrWork[SW_GEOTAGSEL_ID] == 59) width = 795;
    if (gameExeGeoTagHasLink(5, gameExeScrWork[SW_GEOTAGSEL_ID], 0, 0) &&
        mouseSelectHitTest(mouseX, mouseY, 87, 741, width, 55) &&
        InputObject->mouseButtons & MouseLeftClick) {
      *InputMask |= PAD1Y;
    } else if (InputObject->mouseButtons & MouseLeftClick ||
               InputObject->mouseButtons & MouseRightClick) {
      *InputMask |= PAD1B;
    }
  }
...
int __cdecl pokecomMapMainHook() {
  if (*MouseEnabled && gameExeGetFlag(Pokecom_ManualMode)) {
    ...
    // 6517 - MapSize
    if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
      gameExeScrWork[SW_MAP_SIZE] = gameExeScrWork[SW_MAP_SIZE] - 50 > 500
                                        ? gameExeScrWork[SW_MAP_SIZE] - 50
                                        : gameExeScrWork[SW_MAP_SIZE];
    } else if (InputObject->mouseButtonsHeld & MouseScrollWheelDown) {
      gameExeScrWork[SW_MAP_SIZE] = gameExeScrWork[SW_MAP_SIZE] + 50 < 2000
                                        ? gameExeScrWork[SW_MAP_SIZE] + 50
                                        : gameExeScrWork[SW_MAP_SIZE];
    }
      ...
      for (int i = 0; i < *MapNumPoints; i++) {
        if (MapPointIsDisplayed[i]) {
          ...
          int screenX =
              (960 *
                   (MapPointsData[4 * id] -
                    (gameExeScrWork[SW_MAP_POSX] -
                     (960 * gameExeScrWork[SW_MAP_SIZE] / 1000) / 2)) /
                   (960 * gameExeScrWork[SW_MAP_SIZE] / 1000) -
               42) *
              2;
          int screenY =
              (544 *
                   (MapPointsData[4 * id + 1] -
                    (gameExeScrWork[SW_MAP_POSY] -
                     (544 * gameExeScrWork[SW_MAP_SIZE] / 1000) / 2)) /
                   (544 * gameExeScrWork[SW_MAP_SIZE] / 1000) -
               69) *
              2;

          if (menuButtonHitTest(i, mouseX, mouseY, screenX + 18, screenY + 88,
                                MapPointsData[4 * id + 2] * 2 + 120, 76,
                                MapSelectedPointIndex)) {
            if (InputObject->mouseButtons & MouseLeftClick) {
              *InputMask |= PAD1A;
            }
          }
  ...
  if (*MouseEnabled && gameExeGetFlag(Pokecom_ManualMode)) {
    ...
    if (gameExeScrWork[SW_DOC_MODE] == 0) {
      ...
      for (int i = 0; i < gameExeScrWork[SW_DOC_UNLOCKEDNUM]; i++) {
        ...
        if (menuButtonHitTest(i, mouseX, mouseY, 72 + (r * 232),
                              346 + (j * 334), 232, 207,
                              &gameExeScrWork[SW_DOC_SELECTED]) &&
            (InputObject->mouseButtons & MouseLeftClick))
          *InputMask |= PAD1A;
      }
      ...
      // 6473 - Doc max pos
      if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
        gameExeScrWork[SW_DOC_CURTARGET] =
            gameExeScrWork[SW_DOC_CURTARGET] <= 8
                ? 8
                : gameExeScrWork[SW_DOC_CURTARGET] - 24;
      } else if (InputObject->mouseButtonsHeld & MouseScrollWheelDown) {
        gameExeScrWork[SW_DOC_CURTARGET] =
            gameExeScrWork[SW_DOC_CURTARGET] + 24 >=
                    32 * gameExeScrWork[SW_DOC_CURMAX]
                ? 32 * gameExeScrWork[SW_DOC_CURMAX]
                : gameExeScrWork[SW_DOC_CURTARGET] + 24;
      }
    }
...
void __cdecl twipoMainHook() {
  if (*MouseEnabled) {
    ...
    if (gameExeScrWork[SW_TWIPOMODE] == 0) {
      // Twipo tabs
      for (int i = 0; i < 4; i++) {
        if (mouseSelectHitTest(mouseX, mouseY, 75, 275 + (i * 273), 90, 273) &&
            (InputObject->mouseButtons & MouseLeftClick))
          gameExeScrWork[SW_TWIPOCURTAB] = i;
      }

      // Reply button
      int data = *(int*)(TwipoDataPointers[gameExeScrWork[SW_TWIPOCURTAB]] +
                         8 * gameExeScrWork[SW_TWIPOCURTW]);
      if ((TwipoData1[5 * data] != 0xFFFF) && TwipoData2[data]) {
        if (mouseSelectHitTest(mouseX, mouseY, 1533, 1052, 357, 118) &&
            (InputObject->mouseButtons & MouseLeftClick)) {
          *InputMask |= PAD1A;
        }
      }
      ...
      if ((TwipoTweepCountInTabs[gameExeScrWork[SW_TWIPOCURTAB]] -
           gameExeScrWork[SW_TWIPOCURTW]) > 1) {
        if (mouseSelectHitTest(mouseX, mouseY, 166, 365, 677, 366) &&
            (InputObject->mouseButtons & MouseLeftClick)) {
          *InputMask4 |= PAD1RIGHTSTICKUP;
        }
      }
      if (gameExeScrWork[SW_TWIPOCURTW] > 0) {
        if (mouseSelectHitTest(mouseX, mouseY, 166, 1079, 677, 355) &&
            (InputObject->mouseButtons & MouseLeftClick)) {
      ...
      if (mouseSelectHitTest(mouseX, mouseY, 1332, 497, 94, 70) &&
          (InputObject->mouseButtons & MouseLeftClick)) {
        *InputMask |= PAD1RIGHTSTICKUP;
      }
      if (mouseSelectHitTest(mouseX, mouseY, 1332, 950, 94, 70) &&
          (InputObject->mouseButtons & MouseLeftClick)) {
...
int __cdecl backlogMenuMainHook() {
  if (*MouseEnabled) {
    ...
    int scrollBarY =
        *BacklogDispPosMax <= 380
            ? 106
            : ((391 * *BacklogDispPos / (*BacklogDispPosMax - 380)) + 53) * 2;
    mouseScrollBar(mouseX, mouseY, 1738, scrollBarY + 105, 11, 105, 0,
                   *BacklogDispPosMax - 380, 106, 888, *BacklogDispPos, 0);

    if (!SliderMoving) {
      int startLineIndex =
          *BacklogFirstFullDispLine > 0 ? *BacklogFirstFullDispLine - 1 : 0;
      for (int i = startLineIndex; i < *BacklogLastFullDispLine + 2; i++) {
        int lineY = (BacklogDispLinePosY[i] - *BacklogDispPos + 54 +
                     BacklogDispLineSize[i] + 8) *
                    2;
        if (menuButtonHitTest(i, mouseX, mouseY, 0, lineY, 1725,
                              (BacklogDispLineSize[i] + 8) * 2,
                              BacklogSelectedIndex) &&
            (InputObject->mouseButtons & MouseLeftClick))
          *InputMask |= PAD1A;
      }

      if (ScrollDownToCloseBacklog &&
          (*BacklogDispPos >= *BacklogDispPosMax - 380) &&
      ...
      if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
        ...
        *BacklogDispPos = *BacklogDispPos + 48 >= *BacklogDispPosMax - 388
                              ? *BacklogDispPosMax - 380
                              : *BacklogDispPos + 48;
        gameExeBacklogRecalcMovement();
      }
...
int __cdecl musicMenuMainHook() {
  if (*MouseEnabled) {
    ...
    mouseScrollBar(mouseX, mouseY, 1896, scrollBarY + 138, 20, 138, 0, 31, 300,
                   830, *MusicModeStartIndex, 0);

    if (!SliderMoving) {
      for (int i = 0; i < 15; i++) {
        if (menuButtonHitTest(i, mouseX, mouseY, 0, 346 + (i * 44), 1870, 43,
                              MusicModeCurrentIndex) &&
            (InputObject->mouseButtons & MouseLeftClick))
          *InputMask |= PAD1A;
      }

      if (mouseSelectHitTest(mouseX, mouseY, 1532, 176, 258, 36) &&
          (InputObject->mouseButtons & MouseLeftClick))
        *InputMask |= PAD1Y;

      if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
        *MusicModeStartIndex =
            *MusicModeStartIndex == 0 ? 0 : *MusicModeStartIndex - 1;
      } else if (InputObject->mouseButtonsHeld & MouseScrollWheelDown) {
        *MusicModeStartIndex =
            *MusicModeStartIndex == 31 ? 31 : *MusicModeStartIndex + 1;
      }
...
void __cdecl pokecomMainMenuMainHook() {
  if (*MouseEnabled) {
    ...
    if (menuButtonHitTest(0, mouseX, mouseY, 1, 269, 478, 268,
                          &gameExeScrWork[SW_POKECOMSELNO]) ||
        menuButtonHitTest(1, mouseX, mouseY, 481, 269, 478, 268,
                          &gameExeScrWork[SW_POKECOMSELNO]) ||
        menuButtonHitTest(2, mouseX, mouseY, 1441, 269, 478, 268,
                          &gameExeScrWork[SW_POKECOMSELNO]) ||
        menuButtonHitTest(3, mouseX, mouseY, 1441, 541, 478, 268,
                          &gameExeScrWork[SW_POKECOMSELNO]) ||
        menuButtonHitTest(4, mouseX, mouseY, 481, 812, 478, 268,
                          &gameExeScrWork[SW_POKECOMSELNO]) ||
        menuButtonHitTest(5, mouseX, mouseY, 962, 812, 478, 268,
                          &gameExeScrWork[SW_POKECOMSELNO]) ||
        menuButtonHitTest(6, mouseX, mouseY, 1, 1080, 478, 268,
                          &gameExeScrWork[SW_POKECOMSELNO]) ||
        menuButtonHitTest(7, mouseX, mouseY, 962, 1080, 478, 268,
                          &gameExeScrWork[SW_POKECOMSELNO]) ||
        menuButtonHitTest(8, mouseX, mouseY, 1441, 1080, 478, 268,
                          &gameExeScrWork[SW_POKECOMSELNO])) {
      if (InputObject->mouseButtons & MouseLeftClick) {
        *InputMask |= PAD1A;
      }
...
int __cdecl cgViewModeMainHook() {
  if (*MouseEnabled) {
    ...
    if (InputObject->mouseButtons1 & MouseLeftClick) *InputMask |= PAD1A;

    if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
      *AlbumCGScale = *AlbumCGScale >= *AlbumCGScaleMax ? *AlbumCGScaleMax
                                                        : *AlbumCGScale + 100;
    } else if (InputObject->mouseButtonsHeld & MouseScrollWheelDown) {
      *AlbumCGScale = *AlbumCGScale <= *AlbumCGScaleMin ? *AlbumCGScaleMin
                                                        : *AlbumCGScale - 100;
    }
...
int __cdecl albumMenuMainHook() {
  if (*MouseEnabled) {
    ...
    for (int i = 0; i < 3; i++) {
      for (int j = 0; j < 4; j++) {
        if (menuButtonHitTest(id++, mouseX, mouseY, 88 + (j * 446),
                              396 + (i * 276), 410, 240, CGLibraryItemIndex) &&
            (InputObject->mouseButtons & MouseLeftClick))
          *InputMask2 |= PAD1A;
      }
    }
    ...
    if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
      *CGLibraryPageIndex =
          *CGLibraryPageIndex == 0 ? 12 : *CGLibraryPageIndex - 1;
    } else if (InputObject->mouseButtonsHeld & MouseScrollWheelDown) {
      *CGLibraryPageIndex =
          *CGLibraryPageIndex == 12 ? 0 : *CGLibraryPageIndex + 1;
    }
...
int __cdecl instTipsHook(void* thread) {
  if (*MouseEnabled) {
    ...
    if (TipsMenuTipData[6 * *TipsMenuSelectedTip] & 1 &&
        *TipMenuTipTextHeight > 370) {
      int scrollBarY =
          (316 * *TipsMenuTipTextStartOffset / (*TipMenuTipTextHeight - 370) +
           114) *
          2;
      mouseScrollBar(mouseX, mouseY, 1802, scrollBarY + 105, 11, 105, 0,
                     *TipMenuTipTextHeight - 370, 228, 860,
                     *TipsMenuTipTextStartOffset, 0);
    }

    if (TipsMenuTabTipCount[*TipsMenuCurrentTab] > 19) {
      int scrollBarY = (350 * *TipsMenuStartIndex /
                            (TipsMenuTabTipCount[*TipsMenuCurrentTab] - 19) +
                        79) *
                       2;
      mouseScrollBar(mouseX, mouseY, 634, scrollBarY + 105, 11, 105, 0,
                     TipsMenuTabTipCount[*TipsMenuCurrentTab] - 19, 158, 859,
                     *TipsMenuStartIndex, 1);
    }

    if (!SliderMoving) {
      int count = TipsMenuTabTipCount[*TipsMenuCurrentTab] > 19
                      ? 19
                      : TipsMenuTabTipCount[*TipsMenuCurrentTab];
      for (int i = 0; i < count; i++) {
        if (menuButtonHitTest(i, mouseX, mouseY, 97, 215 + (i * 44), 534, 43,
                              TipsMenuSelectedIndex) &&
            (InputObject->mouseButtons & MouseLeftClick))
          *InputMask |= PAD1A;
      }
      ...
      for (int i = 0; i < 4; i++) {
        if (TipsMenuTabTipCount[i]) {
          if (mouseSelectHitTest(mouseX, mouseY, 94 + (i * 144), 116, 140,
                                 35) &&
              (InputObject->mouseButtons & MouseLeftClick))
      ...
      if ((TipsMenuTabTipCount[*TipsMenuCurrentTab] > 19) &&
          mouseHitTest(mouseX, mouseY, 97, 1013, 560, 890)) {
        if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
          *TipsMenuStartIndex =
              *TipsMenuStartIndex == 0 ? 0 : *TipsMenuStartIndex - 1;
        } else if (InputObject->mouseButtonsHeld & MouseScrollWheelDown) {
          *TipsMenuStartIndex = *TipsMenuStartIndex == maxStartIndex
                                    ? maxStartIndex
                                    : *TipsMenuStartIndex + 1;
        }
      }

      if ((*TipMenuTipTextHeight > 370) &&
          mouseHitTest(mouseX, mouseY, 664, 1013, 1100, 788)) {
        if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
          *TipsMenuTipTextStartOffset = (*TipsMenuTipTextStartOffset - 20) <= 0
                                            ? 0
                                            : *TipsMenuTipTextStartOffset - 20;
        } else if (InputObject->mouseButtonsHeld & MouseScrollWheelDown) {
          *TipsMenuTipTextStartOffset =
              (*TipsMenuTipTextStartOffset + 20) > (*TipMenuTipTextHeight - 370)
                  ? *TipMenuTipTextHeight - 370
                  : *TipsMenuTipTextStartOffset + 20;
        }
      }
...
int __cdecl instSystemMenuHook(void* thread) {
  if (*MouseEnabled) {
    ...
    for (int i = 0; i < 11; i++) {
      if (menuButtonHitTest(i, mouseX, mouseY, 0, 289 + (i * 58), 626, 40,
                            &gameExeScrWork[SW_SYSMENUSELNO]) &&
          (InputObject->mouseButtons & MouseLeftClick))
        *InputMask |= PAD1A;
    }
...
int __cdecl instSystemMesHook(uint8_t* thread) {
  if (*MouseEnabled) {
    ...
    switch (*selNumVar) {
      case 1: {
        if (menuButtonHitTest(0, mouseX, mouseY, 1225, buttonY, 158, 39,
                              selIndexVar) &&
            (InputObject->mouseButtons & MouseLeftClick))
          *InputMask |= PAD1A;
      } break;
      case 2: {
        if (menuButtonHitTest(0, mouseX, mouseY, 1057, buttonY, 158, 39,
                              selIndexVar) ||
            menuButtonHitTest(1, mouseX, mouseY, 1225, buttonY, 158, 39,
                              selIndexVar))
          if (InputObject->mouseButtons & MouseLeftClick) {
            *InputMask |= PAD1A;
          }
...
int __cdecl instSaveMenuHook(uint8_t* thread) {
  if (*MouseEnabled) {
    ...
    if (type == 11) {  // Daily Records/Data Collection
      ...
      for (int i = 0; i < 6; i++) {
        for (int j = 0; j < 7; j++) {
          if (menuButtonHitTest(id++, mouseX, mouseY, 330 + (j * 211),
                                322 + (i * 130), 206, 127, selIndexVar) &&
              (InputObject->mouseButtons & MouseLeftClick))
            *InputMask |= PAD1A;
        }
      }
      ...
      if (!*DataCollectionMode) {
        ...
        if ((*DailyRecordsPageIndex != 0) &&
            mouseSelectHitTest(mouseX, mouseY, 261, 564, 60, 89) &&
            (InputObject->mouseButtons & MouseLeftClick)) {
          *InputMask2 |= PAD1L1;
        }
        if ((*DailyRecordsPageIndex < (*DailyRecordsUnlockedPages - 1)) &&
            mouseSelectHitTest(mouseX, mouseY, 1804, 564, 60, 89) &&
            (InputObject->mouseButtons & MouseLeftClick)) {
          *InputMask2 |= PAD1R1;
        }
      ...
      for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 4; j++) {
          if (menuButtonHitTest(id++, mouseX, mouseY, 98 + (i * 890),
                                327 + (j * 220), 840, 188,
                                SelectedSaveEntryIndex) &&
              (InputObject->mouseButtons & MouseLeftClick))
            *InputMask |= PAD1A;
        }
      }
      ...
      if (InputObject->mouseButtonsHeld & MouseScrollWheelUp) {
        *CurrentSaveMenuPage =
            *CurrentSaveMenuPage == 0 ? 5 : *CurrentSaveMenuPage - 1;
      } else if (InputObject->mouseButtonsHeld & MouseScrollWheelDown) {
        *CurrentSaveMenuPage =
            *CurrentSaveMenuPage == 5 ? 0 : *CurrentSaveMenuPage + 1;
      }
    }
  ...
  if (*MouseEnabled) {
    ...
    if (*SubMenuSelIndex) {
      switch (*SubMenuSelIndex) {
        ...
        case 2: {
          ...
          numItems =
              2 + (gameExeGetFlag(ALBUM_ENA) + gameExeGetFlag(MOVIE_ENA) +
    ...
    if (!*TitleSubMenuAnimCounter) {
      for (int i = 0; i < numItems; i++) {
        if (menuButtonHitTest(i, mouseX, mouseY, 0, 266 + (i * 76), 835, 52,
                              selIndexVar) &&
            (InputObject->mouseButtons & MouseLeftClick))
          *InputMask |= PAD1A;
      }
...
int __fastcall mgsInputExecuteServerHook(MgsInputObj_t* pThis) {
  ...
  if (!*MouseEnabled && pThis->mouseFocused &&
      (InputObject->mouseButtons & MouseLeftClick)) {
  ...
  if (*MouseEnabled && !LockMouseControls) {
    ...
    if (InputObject->mouseButtons & MouseLeftClick) {
      if (gameExeScrWork[SW_GAMEMODE] & 1) {
        if (!mouseHitTest(InputObject->scaledMouseX, InputObject->scaledMouseY,
                          13, 1064, 270, 40) &&
            !(mouseSelectHitTest(InputObject->scaledMouseX,
                                 InputObject->scaledMouseY, 1246, 153, 674,
                                 86) &&
              gameExeGetFlag(CALENDAR_DISP))) {
          *InputMask |= PAD1A;
        }
      } else {
        *InputMask |= PAD1A;
    ...
    if ((InputObject->mouseButtons & MouseLeftClick) &&
        gameExeGetFlag(SF_MESALLSKIP) && gameExeScrWork[SW_GAMEMODE] & 1) {
      *InputMask |= PAD1R1;
    }
    ...
    if (InputObject->mouseButtons & MouseMiddleClick &&
        gameExeScrWork[SW_GAMEMODE] & 1) {
      *InputMask |= PAD1R2;
    }
    ...
    if (ScrollDownToAdvanceText &&
        (InputObject->mouseButtons & MouseScrollWheelDown)) {
      *InputMask |= PAD1A;
    }
  }
