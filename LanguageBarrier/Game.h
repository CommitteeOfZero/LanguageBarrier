...
namespace lb {
	...
	struct SurfaceWrapper {
		...
		static void setShaderRscView(void* surfaceArray, int id, ID3D11ShaderResourceView* rscView) {
			if (!game) {
				SurfaceStructRN* surfaceArrayRN = (SurfaceStructRN*)surfaceArray;
		...
		static void setTexPtr(void* surfaceArray, int id, int subIndex, ID3D11Texture2D* texPtr) {
			if (!game) {
				SurfaceStructRN* surfaceArrayRN = (SurfaceStructRN*)surfaceArray;
